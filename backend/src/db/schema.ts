...
export const users = pgTable("users", {
  ...
  createdAt: timestamp("created_at", { withTimezone: true }) // Đã sửa "create_at" thành "created_at"
    .defaultNow()
    .notNull(),
...
export const products = pgTable("products", {
  ...
  imageKitFileId: text("image_kit_file_id"), // Đã sửa từ imageKitFailed
...
// cascade = "delete children when parent is deleted"; restrict = "don't delete the parent if any child still point at it."
...
export const orderItems = pgTable("order_items", {
  // Đã sửa "order_times" thành "order_items"
  id: uuid("id").defaultRandom().primaryKey(),
